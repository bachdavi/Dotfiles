;;;delve-mode.el --- major mode for editing Delve. -*- coding: utf-8; lexical-binding: t; -*-
...
;; To activate, put this file in ~/.emacs.d/delve/ , say, and then add this to your .emacs.el :
;; (add-to-list 'load-path "~/.emacs.d/delve/")
;; (require 'delve-mode)
...
(setq delve-font-lock-keywords
      (let* (
            ...
            (x-functions '("add" "subtract" "divide" "multiply" "power" "max" "min" "abs" "sqrt" "eq" "neq" "gt" "lt" "lt_eq"
                           "gt_eq" "equal" "count" "sum" "product" "Max" "ArgMax" "Min" "mean" "mse" "rmse" "mae" "sort"
...
(define-derived-mode delve-mode text-mode "delve mode" ;; c-mode "delve mode"
  "Major mode for editing Delve"
  ...
  (setq font-lock-defaults '((delve-font-lock-keywords))))
